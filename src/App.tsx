...
export default function App() {
    ...
    return (
        <div className={`min-h-screen pb-safe flex flex-col font-sans overflow-hidden max-w-md mx-auto relative shadow-2xl transition-colors duration-500 ${isPlaying ? 'bg-gray-900' : 'bg-gray-950'}`}>
            ...
            {/* メインコンテンツ */}
            <main className="flex-1 overflow-y-auto px-5 py-6 space-y-6 relative z-10 flex flex-col">
